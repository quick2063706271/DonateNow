                ...
                components.push (
                    <div>
                        <div className="block">
                            ...
                            <Button onClick={removeWishlist(this.state.userId, value._id.toString(), false)} style = {{backgroundColor: "#C65D7B", color: "white", fontSize: "16px", right: "5%", position: "absolute"}}>Remove</Button>
                            <div className="post">
                                <img
                                    src={`..${value.imageSrc}`} 
                                    className="image" 
